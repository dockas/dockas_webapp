...
import {Basket,NotificationAlert,Badge,Auth,Tracker,RouterUtil} from "common"
...
class Component extends React.Component {
    ...
    componentDidMount() {
        ...
        console.log("test hello : home page")
            ...
            <div className={styles.page}>
                <div className={styles.pageContent}>
                        ...
                        <Bar.Body>
                            <Bar.Menu theme={barMenuTheme}>
                                ...
                                {isSeller && screenSize == "phone" ? (
                                    <Bar.Item theme={barItemMobileTheme}>
                                        <NavLink to="/create/brand" activeClassName="active">
                                ...
                                {isSeller && screenSize == "phone" ? (
                                    <Bar.Item theme={barItemMobileTheme}>
                                        <NavLink to="/create/product" activeClassName="active">
                                        ...
                                        <Dropdown Toggle={<span className={classNames(["icon-circled-user", styles.profileButton])}></span>}
                                            ...
                                            {isAdmin ? (
                                                <Dropdown.Item to="/admin/orders">
                                                    <i18n.Translate text="_NAV_BAR_ADMIN_ITEM_LABEL_" />{/*<span style={{marginLeft: "5px"}}><Label color="#F9690E" scale={0.5}><i18n.Translate text="_NAV_BAR_ADMIN_ITEM_LABEL_" /></Label></span>*/}
                                                </Dropdown.Item>
                                            ) : <span></span>}
                    ...
                    <div className={styles.content}>
                        {RouterUtil.renderRoutes(this.props, "home.page")}
                    </div>
                </div>
