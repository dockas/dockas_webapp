...
import {Api,Product,Basket,Badge,Brand,File,RouterUtil} from "common"
...
class Component extends React.Component {
    ...
    getProduct(props=this.props) {
        ...
        let nameId = lodash.get(props, "match.params.id")
                                    ...
                                    <Grid.Cell span={4}>
                                        <div className={styles.bodyContainer}>
                                            ...
                                            <div className={styles.childrenBodyContainer}>
                                                {RouterUtil.renderRoutes(this.props, "catalog.item.page")}
                                            </div>
                                        </div>
                                    </Grid.Cell>
                                </Grid>
