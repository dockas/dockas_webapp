    ...
    render() {
        ...
        return (
            <div>
                <Container>
                    <h2>
                        <i18n.Translate text="_MY_LISTS_PAGE_TITLE_" />
                    </h2>
                    ...
                    <div className="table-container">
                        <table className={styles.table}>
                            <thead>
                                <tr>
                                    <th></th>
                                    <th><i18n.Translate text="_MY_LISTS_PAGE_NAME_TH_" /></th>
                                    <th><i18n.Translate text="_MY_LISTS_PAGE_ITEMS_COUNT_TH_" /></th>
                                    <th><i18n.Translate text="_MY_LISTS_PAGE_PRICE_TH_" /></th>
                                    <th><i18n.Translate text="_MY_LISTS_PAGE_LAST_PURCHASED_AT_TH_" /></th>
                                    <th></th>
                                </tr>
                            </thead>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <Button scale={0.8} onClick={this.onLoadListButtonClick(list)}>
                                                        <i18n.Translate text="_MY_LISTS_PAGE_LOAD_BUTTON_LABEL_" />
                                                    </Button>
                                                </td>
                                            </tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td colSpan="6" className={styles.infoCellContainer}>
                                            <i18n.Translate text="_MY_LISTS_PAGE_NO_DATA_FOUND_TEXT_" />
                                        </td>
                                    </tr>
                                </tbody>
                            ) }
                ...
                <Modal open={overrideWarningModalOpen}>
                    <Modal.Header>
                        <h3 style={{margin: 0}}>
                            <i18n.Translate text="_MY_LISTS_PAGE_OVERRIDE_WARNING_MODAL_TITLE_" />
                        </h3>
                    </Modal.Header>

                    <Modal.Body>
                        <i18n.Translate text="_MY_LISTS_PAGE_OVERRIDE_WARNING_MODAL_BODY_" />
                    </Modal.Body>
